 ...
 * <!-- end-user-doc -->
 * @see cbml.CbmlPackage#getInfoType()
 * @model
 * @generated
 */
public enum InfoType implements Enumerator {
	/**
	 * The '<em><b>Health Status</b></em>' literal object.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #HEALTH_STATUS_VALUE
	 * @generated
	 * @ordered
	 */
	HEALTH_STATUS(0, "HealthStatus", "HealthStatus"),
	...
	/**
	 * The '<em><b>Health Status</b></em>' literal value.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Health Status</b></em>' literal object isn't clear,
	 ...
	 * @ordered
	 */
	public static final int HEALTH_STATUS_VALUE = 0;
	...
	public static InfoType get(int value) {
		switch (value) {
			case HEALTH_STATUS_VALUE: return HEALTH_STATUS;
